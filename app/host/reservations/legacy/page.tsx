...
function getCleaningStatusText(cleanings: Array<{ status: string; needsAttention: boolean; assignedMembershipId: string | null; attentionReason: string | null }>): {
  text: string;
  ...
  const hasAttention = cleanings.some((c) =>
    c.needsAttention && !c.assignedMembershipId
  );
